...
impl Display for MachineConfiguration {
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        ...
        writeln!(f, "  Recipes:                  {}", self.recipes.iter().join(", "))?;
        writeln!(f, "  Energy Usage:             {} EU/t", self.energy_usage)?;
        writeln!(f, "  Parallels Offset:         {}", self.parallels_offset.as_ref().map_or("Default".into(), u64::to_string))?;
        writeln!(f, "  Parallels Per Tier:       {}", self.parallels_per_tier.as_ref().map_or("Default".into(), u64::to_string))?;
        writeln!(f, "  Speed Modifier:           {}", self.speed_modifier.as_ref().map_or("Default".into(), f64::to_string))?;
        writeln!(f, "  Energy Modifier:          {}", self.energy_modifier.as_ref().map_or("Default".into(), f64::to_string))?;
