...
local machines = {
    ["bender"] = { id = "Industrial Material Press", recipes = { "Bending Machine" }, energyUsage = 4 * UMV },
    ["extruder"] = { id = "Industrial Extrusion Machine", recipes = { "Extruder" }, energyUsage = 4 * UMV },
    ["wiremill"] = { id = "Industrial Wire Factory", recipes = { "Wiremill" }, energyUsage = 4 * UMV },
    ["hammer"] = { id = "Industrial Sledgehammer", recipes = { "Forge Hammer" }, energyUsage = 4 * UMV, tier = 4 },
    ["extractor"] = { id = "Dissection Apparatus", recipes = { "Extractor" }, energyUsage = 4 * UMV },
    ["solidifier"] = { id = "Fluid Shaper", recipes = { "Fluid Solidifier" }, energyUsage = 4 * UMV, expansionWidth = 6 },
    ["cutter"] = { id = "Industrial Cutting Factory", recipes = { "Cutting Machine" }, energyUsage = 4 * UMV },
    ["fextractor"] = { id = "Large Fluid Extractor", recipes = { "Fluid Extractor" }, energyUsage = 4 * UMV, solenoidTier = 12, coilTier = 14},
    ["macerator"] = { id = "Industrial Maceration Stack", recipes = { "Macerator" }, energyUsage = 4 * UMV, tier = 2 },
    ["bfurnace"] = { id = "Blast Furnace", recipes = { "Blast Furnace" }, energyUsage = 1 * ULV, coilTier = 1 },
    ["mebf"] = { id = "Mega Blast Furnace", recipes = { "Blast Furnace" }, energyUsage = 1 * ULV, coilTier = 1 },
    ...
    ["centrifuge"] = { id = "Industrial Centrifuge", recipes = { "Multiblock Centrifuge" }, energyUsage = 4 * UMV },
    ["autoclave"] = { id = "Industrial Autoclave", recipes = { "Autoclave" }, energyUsage = 4 * UMV, coilTier = 14, pipeCasingTier = 4, itemPipeCasingTier = 8 },
    ["mabs"] = { id = "Mega Alloy Blast Smelter", recipes = { "Alloy Blast Smelter" }, energyUsage = 64 * UMV, coilTier = 14, glassTier = 10 },
    ["assembler"] = { id = "Precise Auto-Assembler MT-3662", recipes = { "Assembler" }, energyUsage = 64 * UMV, tier = 5 --[[ Mk4 is tier 5 --]] },
    ...
    ["alloysmelter"] = { id = "Zyngen", recipes = { "Alloy Smelter" }, energyUsage = 4 * UEV, coilTier = 14 },
}
